...
1. Confirm the build is [passing in travis](https://travis-ci.org/mascot6699/DevCruxIOSPod)
...
2. Push a release commit
   ...
   2. Rename the old Master section like:
          ## [1.0.5](https://github.com/mascot6699/DevCruxIOSPod/releases/tag/1.0.5)
